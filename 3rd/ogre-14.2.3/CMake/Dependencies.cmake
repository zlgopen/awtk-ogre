...
if(OGRE_BUILD_DEPENDENCIES AND NOT EXISTS ${OGREDEPS_PATH})
    message(STATUS "Building pugixml")
     if(NOT EXISTS ${PROJECT_BINARY_DIR}/pugixml-1.14.tar.gz)    
    file(DOWNLOAD
    ...
    if (NOT FREETYPE_FOUND)
        ...
        if(NOT EXISTS ${PROJECT_BINARY_DIR}/freetype-2.13.2.tar.gz)    
          file(DOWNLOAD
    ...
    if(MSVC OR MINGW OR SKBUILD) # other platforms dont need this
        ...
        if(NOT EXISTS ${PROJECT_BINARY_DIR}/SDL2-2.28.5.tar.gz)    
          file(DOWNLOAD
    ...
    if(MSVC OR MINGW OR SKBUILD) # other platforms dont need this
      ...
      if(NOT EXISTS ${PROJECT_BINARY_DIR}/zlib-1.3.1.tar.gz)    
        file(DOWNLOAD
      ...
      if(NOT EXISTS ${PROJECT_BINARY_DIR}/v5.3.1.tar.gz)    
        file(DOWNLOAD
    ...
    if(NOT EXISTS ${PROJECT_BINARY_DIR}/3.25.tar.gz)    
      file(DOWNLOAD
